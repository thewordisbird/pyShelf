...
def upload_file(file_stream, filename, content_type):
    ...
    #bucketname = os.environ.get('GOOGLE_STORAGE_BUCKET') or os.environ.get(
    #    'FIREBASE_PROJECT') + '_bucket'

    bucketname = 'pyshself.appspot.com'
...
def delete_cover(file_name):
    """Deletes the cover image from the storage bucket"""
    bucketname = 'pyshself.appspot.com'
